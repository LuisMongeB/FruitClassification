...
def train_model(model, train_loader, valid_loader, criterion, optimizer, scheduler, num_epochs, save_checkpoint=False):
...
if __name__=='__main__':
    ...
    # Get dataset paths
    train_image_paths, valid_image_paths, test_image_paths, classes = get_image_paths(data_dir=args.data_dir)
