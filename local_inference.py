...
if __name__=='__main__':
    ...
    parser.add_argument('--input_dir', type=str, default='../datasets-backup/fruitclassification/test_images')
    ...
    pred_df = pd.DataFrame.from_dict(predictions, orient='index', columns=['Predictions', 'Confidence']).reset_index()
